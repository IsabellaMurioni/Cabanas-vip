    ...
    <footer className="bg-[#fffaf5] py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center items-center gap-8 mb-8">
          {/* Instagram */}
          <a
            href="https://www.instagram.com/cabanas.vip/?hl=es"
            target="_blank"
          ...
          >
            ...
            >
              <div className="w-6 h-6 text-[#775e5e] transition-all duration-300 ease-out hover:text-[#5a4444] flex-shrink-0">
                <svg fill="currentColor" viewBox="0 0 24 24" className="transform transition-transform duration-300 hover:rotate-12">
          ...
          {/* Teléfono */}
          <a href="https://api.whatsapp.com/send?phone=541150995700&text=Hola%20Buen%20día%21%20Podrías%20pasarme%20el%20valor%20de%20una%20cabaña%20para..." target="_blank" className="relative"
          ...
          {/* Email */}
          <a href="mailto:Ventashotelesdelacosta@hotmail.com" className="relative"
